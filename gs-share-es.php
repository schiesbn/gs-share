...
<html>
<head>
    <title>Compartir on GNU Social</title>
    <style>
...
<body>
    ...
    <form action="">
        <fieldset>
            <legend>Compartir en GNU Social</legend>

            <label for="userid">ID de usuario:</label>
            <input id="userid" type="text" name="userid" placeholder="usuario@ejemplo.org" value="<?php echo htmlspecialchars($userid, ENT_QUOTES | ENT_HTML5); ?>" />
            ...
            <input id="bookmark" type="checkbox" name="bookmark" value="bookmark" checked /> <label for="bookmark">Compartir como marcador</label>
